...
public class ShootGunC : MonoBehaviour
{
    ...
    void Shoot()
    {
        ...
        Transform bullet1MID = Instantiate(BulletTrailPrefab, firePoint.position, firePoint.rotation);
        Debug.DrawLine(firePointPosition, (mousePosition - firePointPosition) * 100, Color.cyan);
        bullet1MID.name = "bullet1MID";
        Transform bullet2UP = Instantiate(BulletTrailPrefab, firePoint.position, firePoint.rotation);
        Debug.DrawLine(firePointPosition, (mousePosition - firePointPosition) * 100, Color.cyan);
        bullet2UP.name = "bulletUP";
        Transform bullet3LOW = Instantiate(BulletTrailPrefab, firePoint.position, firePoint.rotation);
        Debug.DrawLine(firePointPosition, (mousePosition - firePointPosition) * 100, Color.cyan);
        bullet3LOW.name = "bulletLOW";
